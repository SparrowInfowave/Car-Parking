...
namespace Coffee.UIExtensions
{
	...
	public class UIGradient : BaseMeshEffect
	{
		...
		[SerializeField] public Color m_Color1 = Color.white;

		[Tooltip("Color2: Bottom or Right.")]
		[SerializeField] public Color m_Color2 = Color.white;

		[Tooltip("Color3: For diagonal.")]
		[SerializeField]public Color m_Color3 = Color.white;

		[Tooltip("Color4: For diagonal.")]
		[SerializeField]public Color m_Color4 = Color.white;
